            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mb-6">
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <a href="#" class="block p-6 bg-green-50 hover:bg-green-100 rounded-lg transition duration-150">
                            <h4 class="font-medium text-green-800 mb-2">サブスクリプション管理</h4>
                            <p class="text-sm text-gray-600">課金プランと支払い状況を管理します</p>
                        </a>

                        <a href="#" class="block p-6 bg-purple-50 hover:bg-purple-100 rounded-lg transition duration-150">
