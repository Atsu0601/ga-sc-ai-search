                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('admin.subscriptions.plans.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <p class="mt-1 text-sm text-gray-600">英数字とアンダースコアのみ使用可能（例: starter, pro, agency）</p>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="mb-4">
                                ...
                                <select id="billing_period" name="billing_period" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                                    <option value="monthly" {{ old('billing_period') === 'monthly' ? 'selected' : '' }}>月額</option>
                                    <option value="yearly" {{ old('billing_period') === 'yearly' ? 'selected' : '' }}>年額</option>
                                </select>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            <div class="mb-4">
                                ...
                                <x-text-input id="website_limit" class="block mt-1 w-full" type="number" name="website_limit" :value="old('website_limit', 1)" required min="1" />
                        ...
                        <div class="mb-4">
                            <div class="flex items-center">
                                <input id="is_active" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" name="is_active" {{ old('is_active') ? 'checked' : '' }} checked>
                        ...
                        <div class="mb-4">
                            <div class="flex items-center">
                                <input id="is_featured" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" name="is_featured" {{ old('is_featured') ? 'checked' : '' }}>
