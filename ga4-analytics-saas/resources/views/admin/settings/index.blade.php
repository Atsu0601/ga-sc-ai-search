                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="#">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="google_client_id" class="block mt-1 w-full" type="text" name="google_client_id" value="{{ env('GOOGLE_CLIENT_ID', '') }}" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="google_client_secret" class="block mt-1 w-full" type="password" name="google_client_secret" value="{{ env('GOOGLE_CLIENT_SECRET', '') }}" />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="openai_api_key" class="block mt-1 w-full" type="password" name="openai_api_key" value="{{ env('OPENAI_API_KEY', '') }}" />
                            <p class="mt-1 text-sm text-gray-600">AIレポート生成用のOpenAI API Key</p>
                        </div>

                        <div class="mb-4">
                            <x-input-label for="stripe_key" :value="__('Stripe公開キー')" />
                            <x-text-input id="stripe_key" class="block mt-1 w-full" type="text" name="stripe_key" value="{{ env('STRIPE_KEY', '') }}" />
                            <p class="mt-1 text-sm text-gray-600">決済処理用のStripe公開キー</p>
                        </div>

                        <div class="mb-4">
                            <x-input-label for="stripe_secret" :value="__('Stripeシークレットキー')" />
                            <x-text-input id="stripe_secret" class="block mt-1 w-full" type="password" name="stripe_secret" value="{{ env('STRIPE_SECRET', '') }}" />
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <form method="POST" action="#">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="trial_days" class="block mt-1 w-full" type="number" name="trial_days" value="14" min="1" />
                        </div>

                        <div class="mb-4">
                            <div class="flex items-center">
                                <input id="maintenance_mode" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" name="maintenance_mode">
                        ...
                        <div class="mb-4">
                            <div class="flex items-center">
                                <input id="debug_mode" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" name="debug_mode">
