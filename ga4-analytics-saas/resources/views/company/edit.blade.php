                    ...
                    <form method="POST" action="{{ route('company.update') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="billing_email" class="block mt-1 w-full" type="email"
                                name="billing_email" :value="old('billing_email', $company->billing_email)" required />
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="contact_person" class="block mt-1 w-full" type="text"
                                name="contact_person" :value="old('contact_person', $company->contact_person)" required />
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            <div class="mb-4">
                                ...
                                <x-text-input id="postal_code" class="block mt-1 w-full" type="text"
                                    name="postal_code" :value="old('postal_code', $company->postal_code)" required />
                            ...
                            <div class="mb-4">
                                ...
                                <x-text-input id="country" class="block mt-1 w-full" type="text" name="country"
                                    :value="old('country', $company->country ?? '日本')" required />
