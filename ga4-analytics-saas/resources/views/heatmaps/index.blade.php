                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    @if ($heatmaps->isEmpty())
                        <div class="text-center py-8">
                            ...
                            <h3 class="mt-2 text-sm font-medium text-gray-900">ヒートマップがありません</h3>
                            <p class="mt-1 text-sm text-gray-500">新しいヒートマップを作成して、ユーザーの行動を分析しましょう。</p>
                            <div class="mt-6">
                                <a href="{{ route('websites.heatmaps.create', $website) }}"
                                                    ...
                                                    <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                                        <a href="{{ $heatmap->page_url }}" target="_blank"
                                                            ...
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                class="h-4 w-4 inline-block ml-1" fill="none"
                                                                viewBox="0 0 24 24" stroke="currentColor">
