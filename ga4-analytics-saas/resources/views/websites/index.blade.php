<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('websites.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                新規ウェブサイト登録
            </a>
        </div>
    </x-slot>
                                ...
                                @foreach ($websites as $website)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="{{ route('websites.show', $website->id) }}" class="text-indigo-600 hover:text-indigo-900 mr-3">
                                                詳細
                                            </a>
                                            <a href="{{ route('websites.edit', $website->id) }}" class="text-yellow-600 hover:text-yellow-900 mr-3">
                                                編集
                                            </a>
